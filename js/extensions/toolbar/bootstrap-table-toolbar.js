...
!function($) {
    ...
    var showAvdSearch = function(pColumns, searchTitle, searchText, that) {
        if (!$("#avdSearchModal" + "_" + that.options.idTable).hasClass("modal")) {
            ...
            vModal += sprintf("   <h4 class=\"modal-title\">%s</h4>", searchTitle + "</br><small class='text-danger text-center'>WARNING: All values specified in this modal must be cleared before searching with the simple search input above the table</small>");
            vModal += "  </div>";
